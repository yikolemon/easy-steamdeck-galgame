...
def test_imports():
    ...
    try:
        from src.utils import run_command, is_zh_locale_enabled, is_fonts_installed
        from src.core.installers import setup_locale
        from src.core.installers import setup_fonts
        from src.core import get_zh_locale_preset
